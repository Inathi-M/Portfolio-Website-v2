...
const data = [
  ...
  },
  {
    ...
    review:
      "The course aims to help students understand the following concepts: (a) Introduction to Semiconductor Physics and Diode basics. (b) Diode circuit model, applications and LEDs (c) Introduction to BJTs and basic models (d) BJT amplifier circuit (only focus on common-emitter) (e) Introduction to Op Amps, op-amp ideal and practical models (f) Opamp inverting and non-inverting applications (g) Introduction to FETs, FET analogue applications and a lot more",
  },
  {
    avatar: download,
